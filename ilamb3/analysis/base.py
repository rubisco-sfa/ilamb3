...
class bias_collier2018:
    def __init__(self, required_variables: list[str]):
        if len(required_variables) > 1:
            raise ValueError(
                f"The bias analysis is meant for a single variable, but you gave {required_variables=}"
            )
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # Initialize
        analysis_name = "Bias"
        varname = self.required_variables[0]
